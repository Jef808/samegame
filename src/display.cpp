...
enum class Color_codes : int {
    ...
    std::string print_cell(const sg::Grid& grid, Cell ndx, Output output_mode, const ClusterT<Cell, CELL_NONE>& cluster = ClusterT<Cell, CELL_NONE>())
    {
    ...
    const std::string to_string(const Grid& grid, const Cell cell, sg::Output output_mode)
    {
